<div align="center">
  ...
  <img src="https://skillicons.dev/icons?i=js,ts,java,spring,react,nodejs,mysql,vite,figma,docker" />
</div>
...
```js
const victor = {
  role: "Co-founder & CINO @Fascode",
  stack: ["TypeScript", "Java/Spring Boot", "React", "Node.js"],
